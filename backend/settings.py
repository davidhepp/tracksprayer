...
ROSBRIDGE_GPS_FIX_TOPIC = os.getenv("TRACKSPRAYER_GPS_FIX_TOPIC", "/gps/fix")
ROSBRIDGE_GPS_FIX_TYPE = os.getenv(
    "TRACKSPRAYER_GPS_FIX_TYPE",
    "sensor_msgs/NavSatFix",
)
ROSBRIDGE_GPS_FIX_TIMEOUT_SECONDS = _float_from_env(
    "TRACKSPRAYER_GPS_FIX_TIMEOUT_SECONDS",
    5.0,
)
